    ...
    <div className="flex justify-center items-center flex-col">
      <div className="flex flex-col items-center space-y-8 lg:flex-row lg:space-y-0 lg:space-x-24 pb-20">
        ...
        <div className="w-64">
          ...
          <p className="text-lg text-center">This is Maxence aka Maxou the loulou (and the goat), the co-creator of this website. He is a BTS SIO student in Lille and did this project in order to improve his developer panel and flourish in his future profession. He did this project to finance his travel to Turkish to recover his beautiful hair.</p>
        </div>
      </div>
